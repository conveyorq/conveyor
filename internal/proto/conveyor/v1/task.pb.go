...
const file_conveyor_v1_task_proto_rawDesc = "" +
	"\n" +
	"\x16conveyor/v1/task.proto\x12\vconveyor.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb1\x03\n" +
...
var file_conveyor_v1_task_proto_depIdxs = []int32{
	...
	5, // 3: conveyor.v1.TaskOptions.timeout:type_name -> google.protobuf.Duration
	4, // 4: conveyor.v1.TaskOptions.deadline:type_name -> google.protobuf.Timestamp
	4, // 5: conveyor.v1.TaskOptions.process_at:type_name -> google.protobuf.Timestamp
	5, // 6: conveyor.v1.TaskOptions.unique_ttl:type_name -> google.protobuf.Duration
	5, // 7: conveyor.v1.TaskOptions.retention:type_name -> google.protobuf.Duration
