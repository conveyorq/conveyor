...
func (x *FireGroup) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
type WebhookLeaseHeartbeat struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *WebhookLeaseHeartbeat) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *WebhookLeaseHeartbeat) GetLeaseId() string {
	if x != nil {
		return x.LeaseId
	}
	return ""
...
type WebhookLeaseResult struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// task_id is the delivered task.
	TaskId string `protobuf:"bytes,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	// lease_id is the delivery the token was minted for.
	...
	Outcome TaskOutcome `protobuf:"varint,3,opt,name=outcome,proto3,enum=conveyor.v1.TaskOutcome" json:"outcome,omitempty"`
...
func (x *WebhookLeaseResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *WebhookLeaseResult) GetLeaseId() string {
	if x != nil {
		return x.LeaseId
	}
	return ""
...
func (x *WebhookLeaseResult) GetOutcome() TaskOutcome {
	if x != nil {
		return x.Outcome
	}
...
func (x *WebhookLeaseResult) GetErrorMsg() string {
	if x != nil {
		return x.ErrorMsg
	}
	return ""
...
func (x *WebhookLeaseResult) GetResult() []byte {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *WebhookReconcile) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_conveyor_v1_messages_proto_rawDesc = "" +
	"\n" +
	"\x1aconveyor/v1/messages.proto\x12\vconveyor.v1\x1a\x19conveyor/v1/service.proto\x1a\x16conveyor/v1/task.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"$\n" +
	...
	"\blease_id\x18\x02 \x01(\tR\aleaseId\"\xb1\x01\n" +
	"\x12WebhookLeaseResult\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12\x19\n" +
	"\blease_id\x18\x02 \x01(\tR\aleaseId\x122\n" +
	"\aoutcome\x18\x03 \x01(\x0e2\x18.conveyor.v1.TaskOutcomeR\aoutcome\x12\x1b\n" +
	"\terror_msg\x18\x04 \x01(\tR\berrorMsg\x12\x16\n" +
	"\x06result\x18\x05 \x01(\fR\x06result\"\x12\n" +
	"\x10WebhookReconcileB\xb2\x01\n" +
...
func file_conveyor_v1_messages_proto_init() {
	...
	file_conveyor_v1_service_proto_init()
